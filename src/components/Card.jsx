...
const Card = ({ name }) => {
    return (
        <div className="border w-[360px] max-h-[370] min-h-fit border-gray-300 rounded-md shadow-md">
            ...
            <div className="p-4 h-fit">
                <h3 className="text-lg font-semibold mb-2">Sample Class Batch 1</h3>
                <p className="text-gray-700 mb-1">Sample Description: Computer Science</p>
            </div>
        </div>
    )
}
