...
export default function Navbar() {
  ...
  return (
    <div className={`flex fixed top-0 justify-between px-3 md:px-16 py-2 w-full  items-center text-sm z-50 ${changeState ? "bg-[#71ce91] bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20  " : "bg-transparent"}  transition-all duration-300 ease-in-out`}>
        <div>
          <Image src="/images/Logo3.png" width={200} height={200} alt='Logo' className='w-full' />
        </div>
