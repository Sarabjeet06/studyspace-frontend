  ...
  return (
    <div className='my-40 overflow-hidden'>
        <div className='mx-auto xl:mx-24 lg:mx-16 xl:max-w-3xl lg:max-w-xl md:max-w-2xl w-11/12 sm:w-5/6'>
            <div className=' rounded-3xl border-[10px] sm:border-[20px] md:border-[32px] border-[#fed890] bg-[#fed890] p-2'>
                <div className='flex justify-between items-center bg-[#b47f61] rounded-[16px] pl-8 pr-8 lg:pr-0 xl:pl-8 lg:pl-4 xl:py-8 lg:py-6 h-fit'>
                    <div className='lg:w-3/5'>
                        <div className='text-4xl text-[#fed890] font-bold my-2'>
                            About Us
                        </div>
                        <div className='xl:w-4/5 lg:w-3/4 mt-4 lg:mt-8 *:py-2 text-amber-100 font-semibold text-xs leading-5'>
                            <p>
                    ...
                    <div className='absolute lg:block hidden xl:right-24 lg:right-16 md:right-6 rounded-full border-[32px] border-[#fed890] h-fit w-fit'>
